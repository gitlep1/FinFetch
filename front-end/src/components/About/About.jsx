export const About = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-6">
        FinFetch is a lightweight, responsive stock dashboard built using React,
        JavaScript, postgreSQL and Tailwind CSS. It allows users to view
        real-time stock data from a free public API like Finnhub or Alpha
        Vantage.
      </p>
      ...
      <p className="mb-6">
        ...
        information. If you sign up to receive verification codes by email, your
        email address is used solely for that purpose and will never be shared
        with third parties.
      </p>
      ...
      <p className="mb-6">
        ...
        APIs and is for informational purposes only. FinFetch does not guarantee
